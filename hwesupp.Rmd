...
Here, we list out the five instances of incorrect degrees of freedom calculations from @sun2021recursive, @wang2022asymptotic, and @wang2021tracing.
...
between 7 - 1 - 1 = 5 to 7 - 1 = 6." We can theoretically determine
...
different (incorrect) model for meiosis than we have studied for
